...
_DEFAULT_FFXIV_PATHS = [
    "G:\\Final Fantasy XIV - Global\\SquareEnix\\FINAL FANTASY XIV - A Realm Reborn",
    "F:\\FFXIV",
]
...
class CoinachReader:
    def __init__(self, coinach_path=None, ffxiv_path=None, verbose=True):
